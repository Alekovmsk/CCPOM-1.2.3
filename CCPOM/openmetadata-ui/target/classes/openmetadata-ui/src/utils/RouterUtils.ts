...
export const getPerimetersDetailsPath = (fqn: string, tab?: string) => {
  let path = tab
    ? ROUTES.PERIMETER_DETAILS_WITH_TAB
    : ROUTES.PERIMETER_DETAILS;
  path = path.replace(PLACEHOLDER_ROUTE_FQN, fqn);
...
export const getKnowledgeCenterPath = (fqn?: string) => {
  let path = ROUTES.KNOWLEDGE_CENTER;
  if (fqn) {
...
export const getClientCenterPath = (fqn?: string) => {
  let path = ROUTES.CLIENT_CENTER;
  if (fqn) {
...
export const getDlaPath = (fqn?: string) => {
  let path = ROUTES.DLAS;
  if (fqn) {
...
export const getSpdPath = (fqn?: string) => {
  let path = ROUTES.SPDS;
  if (fqn) {
...
export const getAutoSystemPath = (fqn?: string) => {
  let path = ROUTES.AUTOSYSTEMS;
  if (fqn) {
...
export const getUserEskPath = (fqn?: string) => {
  let path = ROUTES.USERESKS;
  if (fqn) {
...
export const getKnowledgeCenterPathWithAction = (
  fqn: string,
  action: EntityAction
) => {
  let path = ROUTES.KNOWLEDGE_CENTER_DETAILS_WITH_ACTION;
...
export const getClientCenterPathWithAction = (
  fqn: string,
  action: EntityAction
) => {
  let path = ROUTES.CLIENT_CENTER_DETAILS_WITH_ACTION;
...
export const getPerimeterVersionsPath = (
  perimeterFqn: string,
  version: string
) => {
  let path = ROUTES.PERIMETER_VERSION;
  path = path
    .replace(PLACEHOLDER_ROUTE_FQN, perimeterFqn)
    .replace(PLACEHOLDER_ROUTE_VERSION, version);
...
export const getKnowledgeCenterVersionsPath = (
  knowledgeCenterName: string,
  version: string
) => {
  let path = ROUTES.KNOWLEDGE_CENTER_VERSION;
  path = path
    .replace(PLACEHOLDER_ROUTE_FQN, knowledgeCenterName)
    .replace(PLACEHOLDER_ROUTE_VERSION, version);

  return path;
};

export const getKnowledgeCenterDocumentsVersionsPath = (
  knowledgeCenterDocumentsFQN: string,
  version: string,
  tab?: string
) => {
  let path = tab
    ? ROUTES.KNOWLEDGE_CENTER_DOCUMENTS_VERSION_TAB
    : ROUTES.KNOWLEDGE_CENTER_DOCUMENTS_VERSION;
  path = path
    .replace(PLACEHOLDER_ROUTE_FQN, encodeURIComponent(knowledgeCenterDocumentsFQN))
    .replace(PLACEHOLDER_ROUTE_VERSION, version);
...
export const getClientCenterVersionsPath = (
  clientCenterName: string,
  version: string
) => {
  let path = ROUTES.CLIENT_CENTER_VERSION;
  path = path
    .replace(PLACEHOLDER_ROUTE_FQN, clientCenterName)
    .replace(PLACEHOLDER_ROUTE_VERSION, version);

  return path;
};

export const getClientCenterClientsVersionsPath = (
  clientCenterClientsFQN: string,
  version: string,
  tab?: string
) => {
  let path = tab
    ? ROUTES.CLIENT_CENTER_CLIENTS_VERSION_TAB
    : ROUTES.CLIENT_CENTER_CLIENTS_VERSION;
  path = path
    .replace(PLACEHOLDER_ROUTE_FQN, encodeURIComponent(clientCenterClientsFQN))
    .replace(PLACEHOLDER_ROUTE_VERSION, version);
...
export const getDlaClassificationDetailsPath = (classificationFQN: string) => {
...
export const getSpdClassificationDetailsPath = (classificationFQN: string) => {
...
export const getAutoSystemClassificationDetailsPath = (classificationFQN: string) => {
...
export const getDlaClassificationVersionsPath = (
  classificationFQN: string,
  version: string
) => {
  let path = ROUTES.DLA_VERSION;
  path = path
    .replace(PLACEHOLDER_ROUTE_FQN, classificationFQN)
    .replace(PLACEHOLDER_ROUTE_VERSION, version);
...
export const getSpdClassificationVersionsPath = (
  classificationFQN: string,
  version: string
) => {
  let path = ROUTES.SPD_VERSION;
  path = path
    .replace(PLACEHOLDER_ROUTE_FQN, classificationFQN)
    .replace(PLACEHOLDER_ROUTE_VERSION, version);
