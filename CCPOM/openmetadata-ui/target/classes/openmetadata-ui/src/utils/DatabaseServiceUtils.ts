...
import sapsybaseiqConnection from '../jsons/connectionSchemas/connections/database/sapsybaseiqConnection.json';
...
export const getDatabaseConfig = (type: DatabaseServiceType) => {
  ...
  switch (type as unknown as DatabaseServiceType) {
    ...
    case DatabaseServiceType.Sapsybaseiq: {
      schema = sapsybaseiqConnection;
