...
export const getGroupLabel = (index: string) => {
  ...
  switch (index) {
    ...
    case SearchIndex.KNOWLEDGE_CENTER:
      label = i18next.t('label.knowledge-center-document-plural');
      GroupIcon = IconTable;

      break;
    case SearchIndex.CLIENT_CENTER:
      label = i18next.t('label.client-center-client-plural');
      GroupIcon = IconTable;
    ...
    case SearchIndex.AUTOSYSTEM:
      label = i18next.t('label.auto-system');
      GroupIcon = IconTag;

      break;
    case SearchIndex.USERESK:
      label = i18next.t('label.user-esk');
      GroupIcon = IconTag;
    ...
    case SearchIndex.PERIMETER:
      label = i18next.t('label.perimeter-plural');
      GroupIcon = DataProductIcon;
...
export const getEntityTypeFromSearchIndex = (searchIndex: string) => {
  const commonAssets: Record<string, EntityType> = {
    ...
    [SearchIndex.KNOWLEDGE_CENTER]: EntityType.KNOWLEDGE_CENTER,
    [SearchIndex.CLIENT_CENTER]: EntityType.CLIENT_CENTER,
    ...
    [SearchIndex.PERIMETER]: EntityType.PERIMETER,
  };
