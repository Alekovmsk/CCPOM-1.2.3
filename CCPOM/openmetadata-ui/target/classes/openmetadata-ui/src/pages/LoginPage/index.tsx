...
<Row className="flex bg-body-main flex-grow login-main" data-testid="signin-page">
<Col span={10}>
          <div
            className={classNames('mt-12 text-center flex-col flex-center', {
              'sso-container': !isAuthProviderBasic,
            })}>
           <BrandImage className='logo-login' height="auto" width={300} />
<div className="mt-30 w-80 text-xl font-medium text-white">
