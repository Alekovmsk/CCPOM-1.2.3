...
const TagsPage = () => {
  ...
  const fetchClassifications = async (setCurrent?: boolean) => {
    setIsLoading(true);
    console.log('currentClassification fetch')
    ...
    if (currentClassification?.fullyQualifiedName !== fqn || update) {
      ...
      try {
        ...
        if (currentClassification) {
          ...
          console.log('currentClassification pre try')
          console.log(currentClassification)
          setCurrentClassification(currentClassification);
          console.log('currentClassification try')
          console.log(currentClassification)
        ...
        console.log('currentClassification catch')
        console.log(currentClassification)
        setIsLoading(false);
      }
    }
  ...
  const handleUpdateClassification = async (
    ...
    if (!isUndefined(currentClassification)) {
      ...
      try {
        ...
        console.log('setCurrentClassification((prev) => ({ ...prev, ...response }));')
        console.log(currentClassification)
        if (
          currentClassification?.fullyQualifiedName !==
  ...
  useEffect(() => {
    ...
    console.log('tagCategoryName 1')
    console.log(tagCategoryName)
  }, [tagCategoryName]);
