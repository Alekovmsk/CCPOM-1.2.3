...
const breadcrumb = [
  ...
  {
    name: t('label.add-new-entity', { entity: t('label.policy-v') }),
    url: '',
  },
];
...
const AddPolicyPage = () => {
  ...
  return (
    <ResizablePanels
          ...
          <div
            ...
            <div className="m-t-md">
              <Typography.Paragraph
                ...
                {t('label.add-new-entity', { entity: t('label.policy-v') })}
              </Typography.Paragraph>
              <Form
      ...
      pageTitle={t('label.add-entity', { entity: t('label.policy-v') })}
      secondPanel={{
        children: (
          <>
            <Typography.Paragraph className="text-base font-medium">
              {t('label.add-entity', {
                entity: t('label.policy-v'),
              })}
            </Typography.Paragraph>
