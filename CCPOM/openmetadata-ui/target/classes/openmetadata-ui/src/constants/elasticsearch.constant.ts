...
export const ELASTIC_SEARCH_INDEX_ENTITIES = [
  ...
  {
    value: 'knowledgeCenterDocumnet',
    label: t('label.knowledge-center-document'),
  },
  {
    value: 'clientCenterClient',
    label: t('label.client-center-document'),
  },
  {
    value: 'mlmodel',
  ...
  {
    value: 'spdClassification',
    label: 'spdClassification',
  },
  {
    value: 'dla',
    label: t('label.dla'),
  ...
  {
    value: 'dlaClassification',
    label: 'dlaClassification',
  },
  {
    value: 'document',
    label: 'document',
   ...
   {
    value: 'autoSystem',
    label: t('label.autoSystem'),
  },
  {
    value: 'autoSystemClassification',
    label: 'autoSystemClassification',
  },
  {
    value: 'userEsk',
    label: t('label.userEsk'),
  },
  {
    value: 'userEskClassification',
    label: 'userEskClassification',
  },
];
