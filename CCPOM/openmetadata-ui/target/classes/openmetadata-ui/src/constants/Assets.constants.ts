...
export const AssetsFilterOptions: Array<{
  ...
  {
    label: i18n.t('label.knowledge-center-plural'),
    key: EntityType.KNOWLEDGE_CENTER_DOCUMENT,
    value: SearchIndex.KNOWLEDGE_CENTER,
  },
  {
    label: i18n.t('label.client-center-plural'),
    key: EntityType.CLIENT_CENTER_CLIENT,
    value: SearchIndex.CLIENT_CENTER,
  },
  {
...
export const ASSET_SUB_MENU_FILTER: Array<{
...
}> = [
  {
    ...
    children: [
      ...
      {
        key: SearchIndex.PERIMETER,
        label: i18n.t('label.perimeter-plural'),
        value: EntityType.PERIMETER,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      {
        key: SearchIndex.KNOWLEDGE_CENTER,
        label: i18n.t('label.knowledge-center-plural'),
        value: EntityType.KNOWLEDGE_CENTER_DOCUMENT,
      },
      {
        key: SearchIndex.CLIENT_CENTER,
        label: i18n.t('label.client-center-plural'),
        value: EntityType.CLIENT_CENTER_CLIENT,
      },
      {
        key: SearchIndex.TAG,
      ...
      {
        key: SearchIndex.DLA,
        label: i18n.t('label.dla'),
        value: EntityType.DLA,
      },
      {
        key: SearchIndex.SPD,
        label: i18n.t('label.spd'),
        value: EntityType.SPD,
      },
      {
        key: SearchIndex.AUTOSYSTEM,
        label: i18n.t('label.auto-system'),
        value: EntityType.AUTOSYSTEM,
      },
      {
        key: SearchIndex.USERESK,
        label: i18n.t('label.user-esk'),
        value: EntityType.USERESK,
      },
    ],
  },
];
