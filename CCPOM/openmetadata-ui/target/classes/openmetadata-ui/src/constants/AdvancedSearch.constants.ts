...
export const KNOWLEDGE_CENTER_DROPDOWN_ITEMS = [
  // {
  //   label: t('label.domain'),
  //   key: 'domain.displayName.keyword',
  // },
  ...
  {
    label: t('label.knowledge-center-plural'),
    key: 'knowledgeCenter.name.keyword',
  },
];

export const CLIENT_CENTER_DROPDOWN_ITEMS = [
  // {
  //   label: t('label.domain'),
  //   key: 'domain.displayName.keyword',
  // },
  ...
  {
    label: t('label.client-center-plural'),
    key: 'clientCenter.name.keyword',
  },
];
...
export const DLA_DROPDOWN_ITEMS = [
  {
    label: t('label.domain'),
    key: 'domain.displayName.keyword',
  },
  {
    label: t('label.dla'),
    key: 'dlaClassification.name.keyword',
  },
];

export const SPD_DROPDOWN_ITEMS = [
  {
    label: t('label.domain'),
    key: 'domain.displayName.keyword',
  },
  {
    label: t('label.spd'),
    key: 'spdClassification.name.keyword',
  },
];

export const AUTOSYSTEM_DROPDOWN_ITEMS = [
  {
    label: t('label.domain'),
    key: 'domain.displayName.keyword',
  },
  {
    label: t('label.auto-system'),
    key: 'autoSystemClassification.name.keyword',
  },
];

export const USERESK_DROPDOWN_ITEMS = [
  {
    label: t('label.domain'),
    key: 'domain.displayName.keyword',
  },
  {
    label: t('label.user-esk'),
    key: 'userEskClassification.name.keyword',
  },
];
...
export const PERIMETER_DROPDOWN_ITEMS = [
  {
    label: t('label.domain'),
    key: 'domain.displayName.keyword',
  },
...
export const KNOWLEDGE_CENTER_ASSETS_DROPDOWN_ITEMS = [
  {
    label: t('label.entity-type-plural', {
      entity: t('label.entity'),
    }) as string,
...
export const CLIENT_CENTER_ASSETS_DROPDOWN_ITEMS = [
  {
    label: t('label.entity-type-plural', {
      entity: t('label.entity'),
    }) as string,
