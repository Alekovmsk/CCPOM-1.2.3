...
import { addAssetsToKnowledgeCenterDocument } from '../../../rest/knowledgeCenterAPI';
import { KnowledgeCenterDocument } from '../../../generated/entity/data/knowledgeCenterDocument';
import { addAssetsToClientCenterClient } from '../../../rest/clientCenterAPI';
    ...
    try {
      ...
      switch (type) {
        ...
        case AssetsOfEntity.KNOWLEDGE_CENTER:
          res = await addAssetsToKnowledgeCenterDocument(
        ...
        case AssetsOfEntity.CLIENT_CENTER:
          res = await addAssetsToClientCenterClient(
