...
export type MapPatchAPIResponse = {
  ...
  [EntityType.KNOWLEDGE_CENTER_DOCUMENT]: KnowledgeCenterDocument;
  [EntityType.KNOWLEDGE_CENTER]: KnowledgeCenter;
  [EntityType.CLIENT_CENTER_CLIENT]: ClientCenterClient;
  [EntityType.CLIENT_CENTER]: ClientCenter;
