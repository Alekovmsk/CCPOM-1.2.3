...
const DescriptionLikeV1 = ({
  ...
  const content = (
    <Space
      ...
      size={16}>
      <Space size="middle">
        <Text className="right-panel-label">{entityLabel}</Text>
      ...
      <div>
        {description.trim() ? (
          ...
          <span>{noEntityLabel}</span>
        )}
        <ModalWithMarkdownEditor
          header={t('label.edit-field-for',{fieldName: entityLabel, entityName: entityName })}
...
export default DescriptionLikeV1;
