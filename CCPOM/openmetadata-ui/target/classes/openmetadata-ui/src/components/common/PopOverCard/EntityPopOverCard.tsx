...
import {
  getKnowledgeCentersByName,
  getKnowledgeCenterDocumentByFQN,
} from '../../../rest/knowledgeCenterAPI';
import {
  getClientCentersByName,
  ...
  const getData = useCallback(() => {
    ...
    switch (entityType) {
      ...
      case EntityType.KNOWLEDGE_CENTER_DOCUMENT:
        promise = getKnowledgeCenterDocumentByFQN(getDecodedFqn(entityFQN), 'owner');

        break;
      case EntityType.KNOWLEDGE_CENTER:
        promise = getKnowledgeCentersByName(entityFQN, 'owner');

        break;
      case EntityType.CLIENT_CENTER_CLIENT:
        promise = getClientCenterClientByFQN(getDecodedFqn(entityFQN), 'owner');

        break;
      case EntityType.CLIENT_CENTER:
        promise = getClientCentersByName(entityFQN, 'owner');
