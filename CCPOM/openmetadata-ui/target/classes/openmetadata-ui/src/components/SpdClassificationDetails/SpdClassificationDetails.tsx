 ...
 */
import './spd-classification-details.less'
...
import { ProviderType } from '../../generated/api/spdClassification/createSpdClassification';
import {
  ChangeDescription,
  SpdClassification,
} from '../../generated/entity/spdClassification/spdClassification';
...
import {
  ...
  getTagsTableColumn,
} from '../../utils/SpdClassificationUtils';
import {
...
import {
  getSpdClassificationDetailsPath,
  getSpdClassificationVersionsPath,
...
export interface ClassificationDetailsProps {
  ...
  currentClassification?: SpdClassification;
...
function ClassificationDetails({
  ...
  const versionHandler = useCallback(() => {
    isVersionView
      ? history.push(getSpdClassificationDetailsPath(tagCategoryName))
      : history.push(
          getSpdClassificationVersionsPath(
            tagCategoryName,
  ...
  const tableColumn: ColumnsType<Spd> = useMemo(
    () =>
      getTagsTableColumn({
        isClassificationDisabled,
        classificationPermissions,
