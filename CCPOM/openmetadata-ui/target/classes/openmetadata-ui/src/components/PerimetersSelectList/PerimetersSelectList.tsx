...
import {
  PerimeterSelectOption,
  PerimetersSelectListProps,
  PerimetersSelectRef,
} from './PerimetersSelectList.interface';

const PerimetersSelectList = forwardRef<
  PerimetersSelectRef,
  PerimetersSelectListProps
>(
  (
    ...
    const [options, setOptions] = useState<PerimeterSelectOption[]>([]);
    const [searchValue, setSearchValue] = useState<string>('');
    const [paging, setPaging] = useState<Paging>({} as Paging);
    const [currentPage, setCurrentPage] = useState(1);
    const [selectedValue, setSelectedValue] = useState<Perimeter[]>([]);
    ...
    const onSelectChange = (value: string[]) => {
      const entityObj = value.reduce((result: Perimeter[], item) => {
      ...
      setSelectedValue(entityObj as Perimeter[]);
    };
    ...
    return (
      <Select
        ...
        showSearch
        className="w-full"
        data-testid="perimeter-selector"
...
export default PerimetersSelectList;
