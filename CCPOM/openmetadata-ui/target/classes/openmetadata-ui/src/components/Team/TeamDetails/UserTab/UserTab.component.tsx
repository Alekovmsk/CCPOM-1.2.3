...
export const UserTab = ({
        ...
        label: (
          <ManageButtonItemLabel
            description={t('message.export-entity-help', {
              entity: t('label.user-lowercase-plural'),
            })}
        ...
        label: (
          <ManageButtonItemLabel
            description={t('message.import-entity-help', {
              entity: t('label.team-lowercase-t'),
            })}
  ...
  const addUserButtonTitle = useMemo(() => {
    ...
    return permission.EditAll
      ? t('label.add-new-entity-m', { entity: t('label.user-r') })
      : t('message.no-permission-for-action');
                ...
                {users.length > 0 && permission.EditAll && (
                  <UserSelectableList
                    ...
                    <Button data-testid="add-new-user" type="primary">
                      {t('label.add-entity', { entity: t('label.user-r') })}
                    </Button>
                  </UserSelectableList>
                )}
                <ManageButton
