...
export interface ClientCenterClientTabProps {
...
export type ModifiedClientCenterClient = Omit<ClientCenterClient, 'children'> & {
  children?: ClientCenterClient[];
};

export type MoveClientCenterClientType = {
  from: ClientCenterClient;
  to?: ClientCenterClient;
};
