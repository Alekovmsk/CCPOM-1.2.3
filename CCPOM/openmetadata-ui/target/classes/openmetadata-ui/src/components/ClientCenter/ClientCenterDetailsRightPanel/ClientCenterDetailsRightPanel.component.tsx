...
import { ClientCenter, TagSource } from '../../../generated/entity/data/clientCenter';
import {
  ClientCenterClient,
  TagLabel,
...
import ClientCenterReviewers from './ClientCenterReviewers';
...
const ClientCenterDetailsRightPanel = ({
  permissions,
  selectedData,
  isClientCenter,
  onUpdate,
  ...
  const handleReviewerSave = (data: Array<EntityReference>) => {
    if (!isEqual(data, selectedData.reviewers)) {
      let updatedClientCenter = cloneDeep(selectedData);
      ...
      onUpdate(updatedClientCenter);
    }
  };

  const handleUpdatedOwner = (newOwner: ClientCenter['owner']) => {
    const updatedData = {
      ...selectedData,
      owner: newOwner,
    };
    ...
    (clientCenterData: ClientCenter | ClientCenterClient) => {
      if (isVersionView) {
        const ownerDiff = getDiffByFieldName(
          EntityField.OWNER,
          clientCenterData.changeDescription as ChangeDescription
        );
      ...
      return getOwner(getEntityName(clientCenterData.owner), clientCenterData.owner);
    },
    ...
    <Row gutter={[0, 40]}>
      <Col span={24}>
        <DomainLabel
          ...
          entityType={
            isClientCenter ? EntityType.CLIENT_CENTER : EntityType.CLIENT_CENTER_CLIENT
          }
          hasPermission={permissions.EditAll}
        />
      </Col>
      <Col data-testid="client-center-owner-name" span="24">
      ...
      <Col data-testid="client-center-reviewer" span="24">
        <div
          ...
          <Typography.Text
            ...
            data-testid="client-center-reviewer-heading-name">
      ...
      <Col span="24">
        <div data-testid="client-center-tags-name">
          {isClientCenter && (
            <TagsContainerV2
...
export default ClientCenterDetailsRightPanel;
