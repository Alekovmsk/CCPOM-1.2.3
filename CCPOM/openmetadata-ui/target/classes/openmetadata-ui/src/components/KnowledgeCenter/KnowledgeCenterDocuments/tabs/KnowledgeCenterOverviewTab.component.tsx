...
const KnowledgeCenterOverviewTab = ({
  selectedData,
  permissions,
  onUpdate,
  isKnowledgeCenter,
      ...
      <Col
        ...
        <Row className="p-md p-r-0" gutter={[0, 32]}>
          <Col span={24}>
            ...
            /> */}
            {!isKnowledgeCenter &&
              <KnowledgeCenterDocumentInfoCard initialValues={selectedData as KnowledgeCenterDocument} />}
          </Col>
          {/* <Col span={24}>
            <Row gutter={[0, 40]}>
              {!isKnowledgeCenter && (
...
export default KnowledgeCenterOverviewTab;
