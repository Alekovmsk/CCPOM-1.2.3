...
import { validateTagAddtionToKnowledgeCenter } from '../../../rest/knowledgeCenterAPI';
import {
...
import {
  KnowledgeCenterUpdateConfirmationModalProps,
  UpdateState,
} from './KnowledgeCenterUpdateConfirmationModal.interface';

export const KnowledgeCenterUpdateConfirmationModal = ({
  ...
  const handleUpdateConfirmation = async () => {
    ...
    try {
      ...
      const res = await validateTagAddtionToKnowledgeCenter(
        { ...knowledgeCenterDocument, tags: updatedTags } as KnowledgeCenterDocument,
        true
      );
          ...
          content: (
            <div className="d-flex items-center flex-column gap-2">
              ...
              <Typography.Text className="text-center">
                {t('message.knowledge-center-tag-update-description')}{' '}
                <span className="font-medium">
                  {getEntityName(knowledgeCenterDocument)}
                </span>
              </Typography.Text>
            ...
            <div className="d-flex flex-column gap-2">
              {failedStatus && (
                <>
                  ...
                  <Alert
                    className="m-t-sm"
                    message={t('message.knowledge-center-tag-assignement-help-message')}
                    type="warning"
                  />
                </>
              )}
    ...
    <Modal
      ...
      title={
        [
          ...
          ? t('message.knowledge-center-tag-update-modal-title')
          : undefined
      }
