...
import '../../components/MyData/LeftSidebar/left-sidebar.less';
...
const NavBar = ({
  ...
  const [searchIconCustom, setSearchIconCustom] = useState<string>('icon-searchv1color');
  ...
  const togleSearchBox = () => {
    ...
    searchIconCustom == 'icon-searchv1color' ? setSearchIconCustom('icon-cross') : setSearchIconCustom('icon-searchv1color');
  };

  return (
    <>
      <div className="ant-row justify-between bg-white">
        <Link className="ant-col-6 navbar-container flex-shrink-0" id="openmetadata_logo" to="/"
          style={{ padding: '5px 24px 13px 24px' }}>
          <BrandImage
            isMonoGram
        ...
        <div className="ant-col-10 navbar-container flex-nowrap w-full"
          style={{ justifyContent: 'center' }}>
          {/* <CSSTransition in={isShown} classNames='alert' timeout={300} unmountOnExit> */}
            <div
        ...
        <Space align="center" 
          className="ant-col-8 navbar-container">
          <LeftSidebar />
          {/*<Dropdown
