...
export interface KnowledgeCenterSource extends CommonSource {
  knowledge_center_id: string;
  knowledge_center_name: string;
}

export interface ClientCenterSource extends CommonSource {
  client_center_id: string;
  client_center_name: string;
}

export interface SpdSource extends CommonSource {
  spd_id: string;
  spd_name: string;
}

export interface AutoSystemSource extends CommonSource {
  auto_system_id: string;
  auto_system_name: string;
}

export interface DlaSource extends CommonSource {
  dla_id: string;
  dla_name: string;
}

export interface UserEskSource extends CommonSource {
  user_esk_id: string;
  user_esk_name: string;
}
...
export interface PerimeterSource extends CommonSource {
  perimeter_id: string;
