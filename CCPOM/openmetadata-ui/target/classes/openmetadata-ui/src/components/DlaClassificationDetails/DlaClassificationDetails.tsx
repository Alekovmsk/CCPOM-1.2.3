 ...
 */
import './dla-classification-details.less'
...
import { ProviderType } from '../../generated/api/dlaClassification/createDlaClassification';
import {
  ChangeDescription,
  DlaClassification,
} from '../../generated/entity/dlaClassification/dlaClassification';
...
import {
  ...
  getTagsTableColumn,
} from '../../utils/DlaClassificationUtils';
import {
...
import {
  getDlaClassificationDetailsPath,
  getDlaClassificationVersionsPath,
...
export interface ClassificationDetailsProps {
  ...
  currentClassification?: DlaClassification;
  ...
  handleEditTagClick?: (selectedTag: Dla) => void;
  handleActionDeleteTag?: (record: Dla) => void;
...
function ClassificationDetails({
  ...
  const versionHandler = useCallback(() => {
    isVersionView
      ? history.push(getDlaClassificationDetailsPath(tagCategoryName))
      : history.push(
          getDlaClassificationVersionsPath(
            tagCategoryName,
  ...
  const tableColumn: ColumnsType<Dla> = useMemo(
    () =>
      getTagsTableColumn({
        isClassificationDisabled,
        classificationPermissions,
