...
export enum SearchIndex {
  ...
  KNOWLEDGE_CENTER = 'knowledge_center_document_search_index',
  CLIENT_CENTER = 'client_center_client_search_index',
  MLMODEL = 'mlmodel_search_index',
  TAG = 'tag_search_index',
  DLA = 'dla_search_index',
  SPD = 'spd_search_index',
  SPDCLASSIFICATION = 'spd_classification_search_index',
  AUTOSYSTEM = 'autosystem_search_index',
  USERESK = 'useresk_search_index',
  ...
  PERIMETER = 'perimeter_search_index',
}
