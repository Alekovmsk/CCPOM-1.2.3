...
import sapsybaseiq from '../assets/img/service-icon-sapsybaseiq.png';
...
export const SAPSYBASEIQ = sapsybaseiq;
...
export const BETA_SERVICES = [
  ...
  DatabaseServiceType.Sapsybaseiq,
];
