...
export const LITE_TEXT_BODY_COLOR = '#8C8C8C';
export const TEXT_GREY_MUTED = '#757575';
export const SUCCESS_COLOR = '#008376';
export const LITE_SUCCESS_COLOR = '#e1fcdb';
...
export const PAGE_SIZE_TERMS = 15;
export const PAGE_SIZE_DOCUMENTS = 15;
export const PAGE_SIZE_CLIENTS = 15;
...
export const globalSearchOptions = [
  ...
  { value: SearchIndex.KNOWLEDGE_CENTER, label: t('label.knowledge-center') },
  { value: SearchIndex.CLIENT_CENTER, label: t('label.client-center') },
  // { value: SearchIndex.TAG, label: t('label.tag') },
  // { value: SearchIndex.DLA, label: t('label.dla') },
  // { value: SearchIndex.SPD, label: t('label.spd') },
  // { value: SearchIndex.AUTOSYSTEM, label: t('label.auto-system') },
  // { value: SearchIndex.USERESK, label: t('label.user-esk') },
  // { value: SearchIndex.SEARCH_INDEX, label: t('label.search-index') },
  // { value: SearchIndex.DATA_PRODUCT, label: t('label.data-product') },
  // { value: SearchIndex.PERIMETER, label: t('label.perimeter') },
];
...
export const ROUTES = {
  ...
  DLAS: '/dlas',
  DLA_DETAILS: `/dlas/${PLACEHOLDER_ROUTE_FQN}`,
  DLA_VERSION: `/dlas/${PLACEHOLDER_ROUTE_FQN}/versions/${PLACEHOLDER_ROUTE_VERSION}`,
  SPDS: '/spds',
  SPD_DETAILS: `/spds/${PLACEHOLDER_ROUTE_FQN}`,
  SPD_VERSION: `/spds/${PLACEHOLDER_ROUTE_FQN}/versions/${PLACEHOLDER_ROUTE_VERSION}`,
  AUTOSYSTEMS: '/autoSystems',
  AUTOSYSTEM_DETAILS: `/autoSystems/${PLACEHOLDER_ROUTE_FQN}`,
  AUTOSYSTEM_VERSION: `/autoSystems/${PLACEHOLDER_ROUTE_FQN}/versions/${PLACEHOLDER_ROUTE_VERSION}`,
  USERESKS: '/userEsk',
  USERESK_DETAILS: `/userEsk/${PLACEHOLDER_ROUTE_FQN}`,
  SIGNUP: '/signup',
  REGISTER: '/register',
  SIGNIN: '/signin',
  ...
  PERIMETER_DETAILS: `/perimeter/${PLACEHOLDER_ROUTE_FQN}`,
  PERIMETER_DETAILS_WITH_TAB: `/perimeter/${PLACEHOLDER_ROUTE_FQN}/${PLACEHOLDER_ROUTE_TAB}`,
  PERIMETER_VERSION: `/perimeter/${PLACEHOLDER_ROUTE_FQN}/versions/${PLACEHOLDER_ROUTE_VERSION}`,
  ...
  KNOWLEDGE_CENTER: '/agreementCenter',
  ADD_KNOWLEDGE_CENTER: '/add-agreementCenter',
  KNOWLEDGE_CENTER_DETAILS: `/agreementCenter/${PLACEHOLDER_ROUTE_FQN}`,
  KNOWLEDGE_CENTER_DETAILS_WITH_ACTION: `/agreementCenter/${PLACEHOLDER_ROUTE_FQN}/action/${PLACEHOLDER_ACTION}`,
  ADD_KNOWLEDGE_CENTER_DOCUMENTS: `/agreementCenter/${PLACEHOLDER_ROUTE_FQN}/add-document`,
  KNOWLEDGE_CENTER_DETAILS_WITH_TAB: `/agreementCenter/${PLACEHOLDER_ROUTE_FQN}/${PLACEHOLDER_ROUTE_TAB}`,
  KNOWLEDGE_CENTER_DETAILS_WITH_SUBTAB: `/agreementCenter/${PLACEHOLDER_ROUTE_FQN}/${PLACEHOLDER_ROUTE_TAB}/${PLACEHOLDER_ROUTE_SUB_TAB}`,
  KNOWLEDGE_CENTER_VERSION: `/agreementCenter/${PLACEHOLDER_ROUTE_FQN}/versions/${PLACEHOLDER_ROUTE_VERSION}`,
  KNOWLEDGE_CENTER_DOCUMENTS_VERSION: `/agreementCenter-document/${PLACEHOLDER_ROUTE_FQN}/versions/${PLACEHOLDER_ROUTE_VERSION}`,
  KNOWLEDGE_CENTER_DOCUMENTS_VERSION_TAB: `/agreementCenter-document/${PLACEHOLDER_ROUTE_FQN}/versions/${PLACEHOLDER_ROUTE_VERSION}/${PLACEHOLDER_ROUTE_TAB}`,
  CLIENT_CENTER: '/clientCenter',
  ADD_CLIENT_CENTER: '/add-clientCenter',
  CLIENT_CENTER_DETAILS: `/clientCenter/${PLACEHOLDER_ROUTE_FQN}`,
  CLIENT_CENTER_DETAILS_WITH_ACTION: `/clientCenter/${PLACEHOLDER_ROUTE_FQN}/action/${PLACEHOLDER_ACTION}`,
  ADD_CLIENT_CENTER_CLIENTS: `/clientCenter/${PLACEHOLDER_ROUTE_FQN}/add-client`,
  CLIENT_CENTER_DETAILS_WITH_TAB: `/clientCenter/${PLACEHOLDER_ROUTE_FQN}/${PLACEHOLDER_ROUTE_TAB}`,
  CLIENT_CENTER_DETAILS_WITH_SUBTAB: `/clientCenter/${PLACEHOLDER_ROUTE_FQN}/${PLACEHOLDER_ROUTE_TAB}/${PLACEHOLDER_ROUTE_SUB_TAB}`,
  CLIENT_CENTER_VERSION: `/clientCenter/${PLACEHOLDER_ROUTE_FQN}/versions/${PLACEHOLDER_ROUTE_VERSION}`,
  CLIENT_CENTER_CLIENTS_VERSION: `/clientCenter-client/${PLACEHOLDER_ROUTE_FQN}/versions/${PLACEHOLDER_ROUTE_VERSION}`,
  CLIENT_CENTER_CLIENTS_VERSION_TAB: `/clientCenter-client/${PLACEHOLDER_ROUTE_FQN}/versions/${PLACEHOLDER_ROUTE_VERSION}/${PLACEHOLDER_ROUTE_TAB}`,
  ...
  REQUEST_DLAS: `/request-dlas/${PLACEHOLDER_ROUTE_ENTITY_TYPE}/${PLACEHOLDER_ROUTE_FQN}`,
  REQUEST_SPDS: `/request-spds/${PLACEHOLDER_ROUTE_ENTITY_TYPE}/${PLACEHOLDER_ROUTE_FQN}`,
  REQUEST_AUTOSYSTEMS: `/request-autoSystems/${PLACEHOLDER_ROUTE_ENTITY_TYPE}/${PLACEHOLDER_ROUTE_FQN}`,
  ...
  UPDATE_DLAS: `/update-dlas/${PLACEHOLDER_ROUTE_ENTITY_TYPE}/${PLACEHOLDER_ROUTE_FQN}`,
  UPDATE_SPDS: `/update-spds/${PLACEHOLDER_ROUTE_ENTITY_TYPE}/${PLACEHOLDER_ROUTE_FQN}`,
  UPDATE_AUTOSYSTEMS: `/update-autoSystems/${PLACEHOLDER_ROUTE_ENTITY_TYPE}/${PLACEHOLDER_ROUTE_FQN}`,
...
export const getDlasDetailsPath = (entityFQN: string, columnName?: string) => {
  let path = ROUTES.DLA_DETAILS;
  const classification = getPartialNameFromFQN(entityFQN, ['service']);
  path = path.replace(PLACEHOLDER_ROUTE_FQN, classification);
...
export const getSpdsDetailsPath = (entityFQN: string, columnName?: string) => {
  let path = ROUTES.SPD_DETAILS;
  const classification = getPartialNameFromFQN(entityFQN, ['service']);
  path = path.replace(PLACEHOLDER_ROUTE_FQN, classification);
...
export const getAutoSystemsDetailsPath = (entityFQN: string, columnName?: string) => {
  let path = ROUTES.AUTOSYSTEM_DETAILS;
  // const classification = getPartialNameFromFQN(entityFQN, ['service']);
...
export const getUserEsksDetailsPath = (entityFQN: string, columnName?: string) => {
  let path = ROUTES.USERESK_DETAILS;
  path = path.replace(PLACEHOLDER_ROUTE_FQN, entityFQN);
...
export const getKnowledgeCenterDocumentDetailsPath = (
  knowledgeCenterFQN: string,
  tab?: string,
  subTab = 'all'
) => {
  let path = tab ? ROUTES.KNOWLEDGE_CENTER_DETAILS_WITH_TAB : ROUTES.KNOWLEDGE_CENTER_DETAILS;
  ...
  path = path.replace(PLACEHOLDER_ROUTE_FQN, getEncodedFqn(knowledgeCenterFQN));

  return path;
};

export const getClientCenterClientDetailsPath = (
  clientCenterFQN: string,
  tab?: string,
  subTab = 'all'
) => {
  let path = tab ? ROUTES.CLIENT_CENTER_DETAILS_WITH_TAB : ROUTES.CLIENT_CENTER_DETAILS;
  ...
  path = path.replace(PLACEHOLDER_ROUTE_FQN, getEncodedFqn(clientCenterFQN));
...
export const ENTITY_PATH = {
  ...
  dlas: 'dla',
  spds: 'spd',
  autoSystems: 'autoSystem',
  userEsks: 'userEsk',
  glossaries: 'glossary',
  knowledgeCenters: 'knowledgeCenter',
  clientCenters: 'clientCenter',
