...
export interface KnowledgeCenterDocumentsV1Props {
  isVersionView?: boolean;
  permissions: OperationPermission;
  knowledgeCenterDocument: KnowledgeCenterDocument;
  childKnowledgeCenterDocuments: KnowledgeCenterDocument[];
  handleKnowledgeCenterDocumentUpdate: (data: KnowledgeCenterDocument) => Promise<void>;
  handleKnowledgeCenterDocumentDelete: (id: string) => void;
