...
const LeftSidebar = () => {
  ...
  return (
    <Row style={{ display: 'flex', justifyContent: 'space-around', gap: '25px' }}>
      {sideBarItems.map((item) => (
        <Col key={item.key} span={2} style={{ minWidth: '60px' }}>
          <LeftSidebarItem data={item} />
        </Col>
      ))}
      {/* <Col span={2} style={{ minWidth: '60px' }}>
      <Menu
        ...
        style={{borderRight: 'none', padding: '16px 0'}}
      />
