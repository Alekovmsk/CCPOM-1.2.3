...
import {
  CreateClientCenter,
  EntityReference,
} from '../../../generated/api/data/createClientCenter';
import {
  FieldProp,
  FieldTypes,
  FormItemLayout,
...
import { AddClientCenterProps } from './AddClientCenter.interface';

const AddClientCenter = ({
  header,
  allowAccess = true,
  isLoading,
  slashedBreadcrumb,
  ...
  const rightPanel = (
    <div data-testid="right-panel">
      ...
      <Typography.Text className="mb-5">
        {t('message.create-new-client-center-guide')}
      </Typography.Text>
    </div>
  );
  ...
  const formFields: FieldProp[] = [
    ...
    //     className: 'clientCenter-richtext-editor',
    //     initialValue: '',
    //     height: 'auto',
      ...
      firstPanel={{
        children: (
          <div className="max-width-md w-9/10 service-form-container">
            ...
            <div className="add-clientCenter" data-testid="add-clientCenter">
              <Form form={form} layout="vertical" onFinish={handleSave}>
                ...
                <Space
                  ...
                  size={16}>
                  <Button
                    data-testid="cancel-clientCenter"
                    type="link"
                    onClick={onCancel}>
                    {t('label.cancel')}
                  </Button>
                  <Button
                    data-testid="save-clientCenter"
...
export default AddClientCenter;
