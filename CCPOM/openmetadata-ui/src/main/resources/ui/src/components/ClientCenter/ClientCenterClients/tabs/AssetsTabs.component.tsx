...
import {
  ...
  removeAssetsFromClientCenterClient,
  ...
  (
    {
      ...
      type = AssetsOfEntity.CLIENT_CENTER,
      noDataPlaceholder,
      entityFqn,
      assetCount,
      quickFilterQuery
    ...
    const [activeEntity, setActiveEntity] = useState<
      Domain | DataProduct | ClientCenterClient
    >();
    ...
    const entityTypeString =
      type === AssetsOfEntity.CLIENT_CENTER
        ? t('label.client-center-client-lowercase')
    ...
    const fetchCurrentEntity = useCallback(async () => {
      ...
      switch (type) {
        ...
        case AssetsOfEntity.CLIENT_CENTER:
          data = await getClientCenterClientByFQN(getDecodedFqn(fqn));
      ...
      async (assetsData: SourceType[]) => {
        ...
        try {
          ...
          switch (type) {
            ...
            case AssetsOfEntity.CLIENT_CENTER:
              await removeAssetsFromClientCenterClient(
                activeEntity as ClientCenterClient,
                entities
              );
