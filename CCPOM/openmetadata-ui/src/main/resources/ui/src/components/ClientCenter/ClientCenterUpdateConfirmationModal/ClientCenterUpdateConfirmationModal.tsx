...
import { validateTagAddtionToClientCenter } from '../../../rest/clientCenterAPI';
import {
...
import {
  ClientCenterUpdateConfirmationModalProps,
  UpdateState,
} from './ClientCenterUpdateConfirmationModal.interface';

export const ClientCenterUpdateConfirmationModal = ({
  clientCenterClient,
  onValidationSuccess,
  onCancel,
  updatedTags,
  ...
  const handleUpdateConfirmation = async () => {
    ...
    try {
      ...
      const res = await validateTagAddtionToClientCenter(
        { ...clientCenterClient, tags: updatedTags } as ClientCenterClient,
        true
      );
          ...
          content: (
            <div className="d-flex items-center flex-column gap-2">
              ...
              <Typography.Text className="text-center">
                {t('message.client-center-tag-update-description')}{' '}
                <span className="font-medium">
                  {getEntityName(clientCenterClient)}
                </span>
              </Typography.Text>
            ...
            <div className="d-flex flex-column gap-2">
              {failedStatus && (
                <>
                  ...
                  <Alert
                    className="m-t-sm"
                    message={t('message.client-center-tag-assignement-help-message')}
                    type="warning"
                  />
                </>
              )}
    ...
    <Modal
      ...
      title={
        [
          ...
          ? t('message.client-center-tag-update-modal-title')
          : undefined
      }
