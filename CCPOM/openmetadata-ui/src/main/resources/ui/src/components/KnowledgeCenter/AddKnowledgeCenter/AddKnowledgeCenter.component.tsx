...
import {
  ...
  EntityReference,
} from '../../../generated/api/data/createKnowledgeCenter';
import {
  FieldProp,
  FieldTypes,
  FormItemLayout,
...
import { AddKnowledgeCenterProps } from './AddKnowledgeCenter.interface';

const AddKnowledgeCenter = ({
  header,
  allowAccess = true,
  isLoading,
  slashedBreadcrumb,
  ...
  const handleSave: FormProps['onFinish'] = (formData) => {
    ...
    const data: CreateKnowledgeCenter = {
      name: name.trim(),
  ...
  const rightPanel = (
    <div data-testid="right-panel">
      ...
      <Typography.Text className="mb-5">
        {t('message.create-new-knowledge-center-guide')}
      </Typography.Text>
    </div>
  );
  ...
  const formFields: FieldProp[] = [
    ...
    //     className: 'knowledgeCenter-richtext-editor',
    //     initialValue: '',
    //     height: 'auto',
      ...
      firstPanel={{
        children: (
          <div className="max-width-md w-9/10 service-form-container">
            ...
            <div className="add-knowledgeCenter" data-testid="add-knowledgeCenter">
              <Form form={form} layout="vertical" onFinish={handleSave}>
                ...
                <Space
                  ...
                  size={16}>
                  <Button
                    data-testid="cancel-knowledgeCenter"
                    type="link"
                    onClick={onCancel}>
                    {t('label.cancel')}
                  </Button>
                  <Button
                    data-testid="save-knowledgeCenter"
...
export default AddKnowledgeCenter;
