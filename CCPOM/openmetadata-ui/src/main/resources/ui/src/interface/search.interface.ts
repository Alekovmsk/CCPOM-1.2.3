...
export interface PerimeterSearchSource
  extends SearchSourceBase,
    Perimeter {} // extends EntityInterface
...
export interface SpdClassSearchSource extends SearchSourceBase, Spd {
  id: string; 
} //

export interface AutoSystemClassSearchSource extends SearchSourceBase, AutoSystem {
  id: string; 
} //

export interface UserEskClassSearchSource extends SearchSourceBase, UserEsk {
  id: string; 
} //

export interface DlaClassSearchSource extends SearchSourceBase, Dla {
  id: string;  
} //

export interface SpdClassificationClassSearchSource extends SearchSourceBase, SpdClassification {
  id: string;  
} //

export interface DocumentClassSearchSource extends SearchSourceBase, Document {} //

export interface GlossarySearchSource extends SearchSourceBase, GlossaryTerm {} // extends EntityInterface
export interface KnowledgeCenterSearchSource extends SearchSourceBase, KnowledgeCenterDocument {} // extends EntityInterface
export interface ClientCenterSearchSource extends SearchSourceBase, ClientCenterClient {} // extends EntityInterface
...
export type ExploreSearchSource =
  ...
  | KnowledgeCenterSearchSource
  | ClientCenterSearchSource
  | QuerySearchSource
  | UserSearchSource
  | TeamSearchSource
  | TagClassSearchSource
  | SpdClassSearchSource
  | AutoSystemClassSearchSource
  | UserEskClassSearchSource
  | DlaClassSearchSource
  | DocumentClassSearchSource
...
export type SearchIndexSearchSourceMapping = {
  ...
  [SearchIndex.KNOWLEDGE_CENTER]: KnowledgeCenterSearchSource;
  [SearchIndex.CLIENT_CENTER]: ClientCenterSearchSource;
  ...
  [SearchIndex.SPD]: SpdClassSearchSource;
  [SearchIndex.AUTOSYSTEM]: AutoSystemClassSearchSource;
  [SearchIndex.USERESK]: UserEskClassSearchSource;
  [SearchIndex.DLA]: DlaClassSearchSource;
  [SearchIndex.SPDCLASSIFICATION]: SpdClassificationClassSearchSource;
  [SearchIndex.DOC]: DocumentClassSearchSource;
  ...
  [SearchIndex.PERIMETER]: PerimeterSearchSource;
};
