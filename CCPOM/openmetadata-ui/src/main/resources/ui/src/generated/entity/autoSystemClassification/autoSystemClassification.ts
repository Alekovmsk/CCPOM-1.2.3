 ...
 */
 ...
 /**
 * A `autoSystemClassification` entity contains hierarchical terms called autoSystems used
 * for categorizing and classifying data assets and other entities.
 */
export interface AutoSystemClassification {
    /**
    ...
    /**
     * Link to the resource corresponding to the autoSystem classification.
     */
    href?: string;
    /**
     ...
     * entity have multiple autoSystems simultaneously - example a customer can be `newCustomer`
     * and `atRisk` simultaneously.
     */
    mutuallyExclusive?: boolean;
    name:               string;
    provider?:          ProviderType;
    /**
     * Total number of children autoSystem terms under this autoSystem classification. This
     * includes all the children in the hierarchy.
     */
    termCount?: number;
    /**
