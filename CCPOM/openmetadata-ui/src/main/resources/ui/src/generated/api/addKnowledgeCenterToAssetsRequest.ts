 ...
 */
export interface AddKnowledgeCenterToAssetsRequest {
    /**
     * List of assets to be created against which the knowledgeCenter needs to be added.
     */
