...
export const getField = (field: FieldProp) => {
  ...
  switch (type) {
    ...
    case FieldTypes.TEXTAREA:
      fieldElement = <Input.TextArea {...props} id={id} placeholder={placeholder} />;

    break;
    case FieldTypes.DATEPICKER:
        fieldElement = <DatePicker {...props} id={id} placeholder={placeholder} format={"DD-MM-YYYY"} showTime={false} />;
    ...
    case FieldTypes.ASYNC_SELECT_LIST_NO_TAG:
      fieldElement = (
        <AsyncSelectListNoTag {...(props as unknown as AsyncSelectListProps)} />
      );
  ...
  const isDate = formItemProps ? formItemProps.valuePropName === 'date' : false;
  const isExpirationDate = props ? props['data-testid'] === 'expirationDate' : false;
