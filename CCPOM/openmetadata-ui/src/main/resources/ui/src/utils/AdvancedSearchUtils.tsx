...
import {
  ...
  PERIMETER_DROPDOWN_ITEMS,
  DLA_DROPDOWN_ITEMS,
  DOMAIN_DATAPRODUCT_DROPDOWN_ITEMS,
  GLOSSARY_ASSETS_DROPDOWN_ITEMS,
  GLOSSARY_DROPDOWN_ITEMS,
  KNOWLEDGE_CENTER_ASSETS_DROPDOWN_ITEMS,
  KNOWLEDGE_CENTER_DROPDOWN_ITEMS,
  CLIENT_CENTER_ASSETS_DROPDOWN_ITEMS,
  CLIENT_CENTER_DROPDOWN_ITEMS,
  PIPELINE_DROPDOWN_ITEMS,
  SEARCH_INDEX_DROPDOWN_ITEMS,
  SPD_DROPDOWN_ITEMS,
  AUTOSYSTEM_DROPDOWN_ITEMS,
  TABLE_DROPDOWN_ITEMS,
  TAG_DROPDOWN_ITEMS,
  TOPIC_DROPDOWN_ITEMS,
  USERESK_DROPDOWN_ITEMS,
...
export const getDropDownItems = (index: string) => {
  switch (index) {
    ...
    case SearchIndex.KNOWLEDGE_CENTER:
      return [...KNOWLEDGE_CENTER_DROPDOWN_ITEMS];
    case SearchIndex.CLIENT_CENTER:
      return [...CLIENT_CENTER_DROPDOWN_ITEMS];
    case SearchIndex.TAG:
      return [...TAG_DROPDOWN_ITEMS];
    case SearchIndex.DLA:
      return [...DLA_DROPDOWN_ITEMS];
    case SearchIndex.AUTOSYSTEM:
      return [...AUTOSYSTEM_DROPDOWN_ITEMS];
    case SearchIndex.USERESK:
      return [...USERESK_DROPDOWN_ITEMS];
    case SearchIndex.SPD:
      return [...SPD_DROPDOWN_ITEMS];
    case SearchIndex.DATA_PRODUCT:
      return [...DATA_PRODUCT_DROPDOWN_ITEMS];
    case SearchIndex.PERIMETER:
      return [...PERIMETER_DROPDOWN_ITEMS];
    default:
      return [];
  }
};
...
export const getAssetsPageQuickFilters = (type: AssetsOfEntity) => {
  switch (type) {
    ...
    case AssetsOfEntity.KNOWLEDGE_CENTER:
      return [...KNOWLEDGE_CENTER_ASSETS_DROPDOWN_ITEMS];
    case AssetsOfEntity.CLIENT_CENTER:
      return [...CLIENT_CENTER_ASSETS_DROPDOWN_ITEMS];
    default:
      return [...COMMON_DROPDOWN_ITEMS];
  }
