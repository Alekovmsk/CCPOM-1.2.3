...
export const getEntityLink = (
  ...
  switch (indexType) {
    ...
    case SearchIndex.KNOWLEDGE_CENTER:
      return getKnowledgeCenterPath(getDecodedFqn(fullyQualifiedName));

    case EntityType.CLIENT_CENTER:
    case EntityType.CLIENT_CENTER_CLIENT:
    case SearchIndex.CLIENT_CENTER:
      return getClientCenterPath(getDecodedFqn(fullyQualifiedName));
    ...
    case SearchIndex.DLA:
      return getDlasDetailsPath(fullyQualifiedName);
    case SearchIndex.SPD:
      return getSpdsDetailsPath(fullyQualifiedName);
    case SearchIndex.AUTOSYSTEM:
      return getAutoSystemsDetailsPath(fullyQualifiedName);
    case SearchIndex.USERESK:
      return getUserEsksDetailsPath(fullyQualifiedName);
    ...
    case SearchIndex.PERIMETER:
      return getPerimetersDetailsPath(fullyQualifiedName);
...
export const getServiceIcon = (source: SourceType) => {
  ...
  } else if (source.entityType === EntityType.KNOWLEDGE_CENTER_DOCUMENT) {
    return (
      <KnowledgeCenterIcon
        className="service-icon h-7"
        style={{ color: DE_ACTIVE_COLOR }}
  ...
  } else if (source.entityType === EntityType.CLIENT_CENTER_CLIENT) {
    return (
      <ClientCenterIcon
        className="service-icon h-7"
        style={{ color: DE_ACTIVE_COLOR }}
...
export const getEntityIcon = (indexType: string) => {
  switch (indexType) {
    ...
    case SearchIndex.KNOWLEDGE_CENTER:
    case EntityType.KNOWLEDGE_CENTER:
      return <KnowledgeCenterIcon />;
    case EntityType.KNOWLEDGE_CENTER_DOCUMENT:
      return <KnowledgeCenterIcon />;
    case SearchIndex.CLIENT_CENTER:
    case EntityType.CLIENT_CENTER:
      return <ClientCenterIcon />;
    case EntityType.CLIENT_CENTER_CLIENT:
      return <ClientCenterIcon />;
