...
export const fetchKnowledgeCenterList = async (
  searchQueryParam: string,
  page: number
): Promise<{
  data: {
  ...
  const knowledgeCenterResponse = await searchQuery({
    query: searchQueryParam ? `*${searchQueryParam}*` : '*',
    pageNumber: page,
    pageSize: 10,
    queryFilter: {},
  ...
  const hits = knowledgeCenterResponse.hits.hits;
  ...
  return {
    ...
    paging: {
      total: knowledgeCenterResponse.hits.total.value,
    },
  };
};

export const fetchClientCenterList = async (
  searchQueryParam: string,
  page: number
): Promise<{
  data: {
  ...
  const clientCenterResponse = await searchQuery({
    query: searchQueryParam ? `*${searchQueryParam}*` : '*',
    pageNumber: page,
    pageSize: 10,
    queryFilter: {},
  ...
  const hits = clientCenterResponse.hits.hits;
  ...
  return {
    ...
    paging: {
      total: clientCenterResponse.hits.total.value,
    },
  };
};
