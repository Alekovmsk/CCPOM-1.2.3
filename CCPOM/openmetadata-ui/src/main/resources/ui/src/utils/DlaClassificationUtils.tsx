...
import { Dla,EntityReference } from '../generated/entity/dlaClassification/dla';
...
export const getCommonColumns = (): ColumnsType<Dla> => [
  {
...
export const getTagsTableColumn = ({
  ...
  const columns: ColumnsType<Dla> = getCommonColumns();
