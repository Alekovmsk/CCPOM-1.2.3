...
describe('#AddCommand', function () {
    ...
    describe('builder', function () {
        it('should configure yargs', function () {
            ...
            var returned = MockeryAddCommand.builder(yargs);
    ...
    describe('handler', function () {
        it('should manage license', function () {
            ...
            expect(manageLicenseStub).to.have.been.calledOnceWithExactly('some args', license_manager_1.ManagementMode.INSERT);
        });
    });
});
