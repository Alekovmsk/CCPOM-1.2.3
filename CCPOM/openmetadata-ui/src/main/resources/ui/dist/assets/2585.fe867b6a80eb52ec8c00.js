  ...
  <section id='auth' part="section-auth" style="text-align:left; direction:ltr; margin-top:24px; margin-bottom:24px;" class = 'observe-me ${"read focused".includes(this.renderStyle)?"section-gap--read-mode":"section-gap "}'>
    ...
    <div class="small-font-size" style="display:flex; align-items: center; min-height:30px">
      ${t.length>0?U`
          ...
          <button class="m-btn thin-border" part="btn btn-outline" @click=${()=>{O_.call(this)}}>CLEAR ALL API KEYS</button>`:U`<div class="red-text">No API key applied</div>`}
    </div>
  ...
  <div class="tab-panel col"
    ...
    ${e.map(((e,t)=>{var r,n,o;return U`
      <div class="tab-content m-markdown" style= "display:${0===t?"block":"none"}" data-tab = '${e.lang}${t}'>
        ...
        <pre><code class="language">${Ge().languages[null===(r=e.lang)||void 0===r?void 0:r.toLowerCase()]?k_(Ge().highlight(e.source,Ge().languages[null===(n=e.lang)||void 0===n?void 0:n.toLowerCase()],null===(o=e.lang)||void 0===o?void 0:o.toLowerCase())):e.source}</code></pre>
      </div>`}))}
  </div>  
  </section>`}function U_(e){return U`
    ...
    `))}
  `}const z_={},M_=x_(class extends w_{constructor(){super(...arguments),this.ot=z_}render(e,t){return t()}update(e,[t,r]){if(Array.isArray(t)){if(Array.isArray(this.ot)&&this.ot.length===t.length&&t.every(((e,t)=>e===this.ot[t])))return z}else if(this.ot===t)return z;return this.ot=Array.isArray(t)?Array.from(t):t,this.render(t,r)}}),{I:H_}=ne,W_={},V_=x_(class extends w_{constructor(e){if(super(e),3!==e.type&&1!==e.type&&4!==e.type)throw Error("The `live` directive is not allowed on child or event bindings");if(!(e=>void 0===e.strings)(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===z||t===M)return t;const r=e.element,n=e.name;if(3===e.type){if(t===r[n])return z}else if(4===e.type){if(!!t===r.hasAttribute(n))return z}else if(1===e.type&&r.getAttribute(n)===t+"")return z;return((e,t=W_)=>{e._$AH=t})(e),t}});var G_=n(131),K_=n.n(G_);const J_=p`
.border-top {
  border-top:1px solid var(--border-color);
}
.border{
...
`;function hP(e){const t=new We.Renderer;return t.heading=(t,r,n,o)=>`<h${r} class="observe-me" id="${e}--${o.slug(n)}">${t}</h${r}>`,t}function fP(e){const t=e.target.closest(".tag-container").querySelector(".tag-description"),r=e.target.closest(".tag-container").querySelector(".tag-icon");t&&r&&(t.classList.contains("expanded")?(t.style.maxHeight=0,t.classList.replace("expanded","collapsed"),r.classList.replace("expanded","collapsed")):(t.style.maxHeight=`${t.scrollHeight}px`,t.classList.replace("collapsed","expanded"),r.classList.replace("collapsed","expanded")))}function mP(e,t="",r=""){var n,o,a,i,s,l,c,p,d;const u=new Set;for(const t in e.responses)for(const r in null===(h=e.responses[t])||void 0===h?void 0:h.content){var h;u.add(r.trim())}const f=[...u].join(", "),m=this.resolvedSpec.securitySchemes.filter((t=>{var r;return t.finalKeyValue&&(null===(r=e.security)||void 0===r?void 0:r.some((e=>t.securitySchemeId in e)))}))||[],y=this.resolvedSpec.securitySchemes.find((e=>e.securitySchemeId===at&&"-"!==e.value));y&&m.push(y);const g=e.xCodeSamples?q_.call(this,e.xCodeSamples):"";return U`
    ...
    <div class='expanded-endpoint-body observe-me ${e.method} ${e.deprecated?"deprecated":""} ' part="section-operation ${e.elementId}" id='${e.elementId}'>
          ...
          <div class="tag-container" part="section-operation-tag"> 
            ...
            ${r?U`
                ...
                <div class="tag-description collapsed" style="max-height:0px; overflow:hidden; margin-top:16px; border:1px solid var(--border-color)"> 
                  <div class="m-markdown" style="padding:8px"> ${k_(We(r))}</div>  
                </div>`:""}  
          </div>
        `:""}
      ...
      ${e.description?U`<div class="m-markdown"> ${k_(We(e.description))}</div>`:""}
      ...
      ${null!==(o=e.externalDocs)&&void 0!==o&&o.url||null!==(a=e.externalDocs)&&void 0!==a&&a.description?U`<div style="background-color:var(--bg3); padding:2px 8px 8px 8px; margin:8px 0; border-radius:var(--border-radius)"> 
            <div class="m-markdown"> ${k_(We((null===(i=e.externalDocs)||void 0===i?void 0:i.description)||""))} </div>
  ...
  `}function yP(){return this.resolvedSpec?U`
  ${this.resolvedSpec.tags.map((e=>U`
    <section id="${e.elementId}" part="section-tag" class="regular-font section-gap--read-mode observe-me" style="border-top:1px solid var(--primary-color);">
      ...
      ${k_(`\n          <div class="m-markdown regular-font">\n          ${We(e.description||"","true"===this.infoDescriptionHeadingsInNavBar?{renderer:hP(e.elementId)}:void 0)}\n        </div>`)}
      </div>
    </section>
...
`:""}function gP(e){return U`
  ...
  ${"table"===this.schemaStyle?U`
      ...
      <schema-tree
        ...
        exportparts = "schema-description:schema-description, schema-multiline-toggle:schema-multiline-toggle"
      > </schema-tree>`}
  </div>`}function vP(e,t){return-1!==e.id.indexOf("schemas-")?gP.call(this,e):U`
  <div class='divider'></div>
  <div class='expanded-endpoint-body observe-me ${e.name}' id='cmp--${e.id}' >
    ${U`
  ...
  `}function bP(){return this.resolvedSpec?U`
  ${this.resolvedSpec.components.map((e=>U`
    <div id="cmp--${e.name.toLowerCase()}" class='regular-font section-gap--read-mode observe-me' style="border-top:1px solid var(--primary-color);">
      ...
      <div class="regular-font-size">
        ${k_(`<div class='m-markdown regular-font'>${We(e.description?e.description:"")}</div>`)}
      </div>
    </div>
    ...
    `))}
`:""}function xP(){const e=new We.Renderer;return e.heading=(e,t,r,n)=>`<h${t} class="observe-me" id="overview--${n.slug(r)}">${e}</h${t}>`,e}function wP(){var e,t,r,n;return U`
  ...
  `}function $P(e){var t;const r=null===(t=this.resolvedSpec)||void 0===t?void 0:t.servers.find((t=>t.url===e));return!!r&&(this.selectedServer=r,this.requestUpdate(),this.dispatchEvent(new CustomEvent("api-server-change",{bubbles:!0,composed:!0,detail:{selectedServer:r}})),!0)}function kP(e,t){const r=[...e.currentTarget.closest("table").querySelectorAll("input, select")];let n=t.url;r.forEach((e=>{const t=new RegExp(`{${e.dataset.var}}`,"g");n=n.replace(t,e.value)})),t.computedUrl=n,this.requestUpdate()}function SP(){return this.selectedServer&&this.selectedServer.variables?U`
    ...
    <table class='m-table' role='presentation'>
      ${Object.entries(this.selectedServer.variables).map((e=>U`
        ...
        ${e[1].description?U`<tr><td colspan="2" style="border:none"><span class="m-markdown-small"> ${k_(We(e[1].description))} </span></td></tr>`:""}
      `))}
    </table>
    `:""}function AP(){var e,t,r;return!this.resolvedSpec||this.resolvedSpec.specLoadError?"":U`
  ...
  <nav class='nav-bar ${this.renderStyle}' part='section-navbar'>
    ...
    ${"false"===this.allowSearch&&"false"===this.allowAdvancedSearch?"":U`
      ...
      `}
    ${U`<nav class='nav-scroll' tabindex='-1' part='section-navbar-scroll' @click='${e=>OP.call(this,e)}' @keyup='${e=>OP.call(this,e)}' >
...
`}function CP(e){const t=new We.Renderer;return t.heading=(t,r,n,o)=>`<h${r} class="observe-me" id="${e}--${o.slug(n)}">${t}</h${r}>`,t}function jP(e){return U`
    <div class='regular-font section-gap--focused-mode' part="section-operations-in-tag">
      ${e}
    </div>`}function IP(){var e;if("true"===this.showInfo)return jP(wP.call(this));const t=this.resolvedSpec.tags[0],r=null===(e=this.resolvedSpec.tags[0])||void 0===e?void 0:e.paths[0];return jP(t&&r?mP.call(this,r,t.name):"")}function _P(e){return U`
    <h1 id="${e.elementId}">${e.name}</h1>
    ${"show-description"===this.onNavTagClick&&e.description?U`
        <div class="m-markdown">
          ${k_(`\n            <div class="m-markdown regular-font">\n              ${We(e.description||"","true"===this.infoDescriptionHeadingsInNavBar?{renderer:CP(e.elementId)}:void 0)}\n            </div>`)}
        </div>`:""}
  `}function PP(){if(!this.focusedElementId||!this.resolvedSpec)return;const e=this.focusedElementId;let t,r=null,n=null,o=0;if(e.startsWith("overview")&&"true"===this.showInfo)t=wP.call(this);else if("auth"===e&&"true"===this.allowAuthentication)t=B_.call(this);else if("servers"===e&&"true"===this.allowServerSelection)t=AP.call(this);else if("operations-top"===e)t=U`
  ...
  <div part="section-endpoint-body-${e.expanded?"expanded":"collapsed"}" class='endpoint-body ${e.method} ${e.deprecated?"deprecated":""}'>
    <div class="summary">
      ...
      ${e.description?U`<div part="section-endpoint-body-description" class="m-markdown"> ${k_(We(e.description))}</div>`:""}
      ${null!==(r=e.externalDocs)&&void 0!==r&&r.url||null!==(n=e.externalDocs)&&void 0!==n&&n.description?U`<div style="background-color:var(--bg3); padding:2px 8px 8px 8px; margin:8px 0; border-radius:var(--border-radius)"> 
            <div class="m-markdown"> ${k_(We((null===(o=e.externalDocs)||void 0===o?void 0:o.description)||""))} </div>
  ...
  </div>`}function NP(e=!0,t=!0,r=!1){return this.resolvedSpec?U`
    ${e?U`
...
`}
    ...
    <div style="margin: 0px 8px;display:flex;flex:1">
      ...
      <div class="tree ${"true"===this.schemaDescriptionExpanded?"expanded-all-descr":"collapsed-all-descr"}" @click="${e=>this.handleAllEvents(e)}">
        ...
        <span part="schema-description" class='m-markdown'> ${k_(We((null===(r=this.data)||void 0===r?void 0:r["::description"])||""))}</span>
        ${this.data?U`
    ...
    `}generateTree(e,t="object",r="",n="",o="",a=0,i=0,s=""){var l;if("true"===this.schemaHideReadOnly){if("array"===t&&"readonly"===s)return;if("readonly"===(null==e?void 0:e["::readwrite"]))return}if("true"===this.schemaHideWriteOnly){if("array"===t&&"writeonly"===s)return;if("writeonly"===(null==e?void 0:e["::readwrite"]))return}if(!e)return U`<div class="null" style="display:inline;">
        ...
        <div class="tr ${a<this.schemaExpandLevel||null!==(y=e["::type"])&&void 0!==y&&y.startsWith("xxx-of")?"expanded":"collapsed"} ${e["::type"]||"no-type-info"}" title="${e["::deprecated"]?"Deprecated":""}">
          ...
          <div class='td key-descr m-markdown-small'>${k_(We(o||""))}</div>
        </div>
      ...
      <div class = "tr primitive" title="${A?"Deprecated":""}">
        ...
        <div class='td key-descr'>
          ${o||S||k?U`${U`<span class="m-markdown-small">
                ${k_(We("array"===t?`${O} ${o}`:S?`${O} <b>${S}:</b> ${k}`:`${O} ${k}`))}
              </span>`}`:""}  
    ...
    `}renderShortFormatExamples(e,t,r){return U`${e.map(((e,n)=>U`
      ...
      ${e.map((e=>{var n,o;return U`
          <li>
            ...
            ${(null===(o=e.description)||void 0===o?void 0:o.length)>0?U`<p>${k_(We(e.description))}</p>`:""}
          </li>
        `}))}
      ...
      <tr>
        ...
        <td colspan="2" style="border:none">
          <span class="m-markdown-small">${k_(We(r.description||""))}</span>
    ...
    <div style="display:block; overflow-x:auto; max-width:100%;">
      ...
      `,a.forEach((e=>{let a,i=[];if(this.selectedRequestBodyType.includes("json")||this.selectedRequestBodyType.includes("xml")||this.selectedRequestBodyType.includes("text")||this.selectedRequestBodyType.includes("jose"))e.mimeType===this.selectedRequestBodyType&&(i=cP(e.schema,e.mimeType,e.examples,e.example,"true"===this.callback||"true"===this.webhook,"true"!==this.callback&&"true"!==this.webhook,"text",!1),this.selectedRequestBodyExample||(this.selectedRequestBodyExample=i.length>0?i[0].exampleId:""),o=U`
            ${o}
            <div class = 'example-panel border-top pad-top-8'>
              ...
              ${i.filter((e=>e.exampleId===this.selectedRequestBodyExample)).map((t=>U`
                <div class="example ${t.exampleId===this.selectedRequestBodyExample?"example-selected":""}" data-example = '${t.exampleId}'>
                  ...
                  ${t.exampleDescription?U`<div class="m-markdown-small" style="padding: 4px 0"> ${k_(We(t.exampleDescription||""))} </div>`:""}
          ...
          `);(e.mimeType.includes("json")||e.mimeType.includes("xml")||e.mimeType.includes("text")||this.selectedRequestBodyType.includes("jose"))&&(a=lP(e.schema,{}),"table"===this.schemaStyle?n=U`
            ${n}
            <schema-table
      ...
      <div class='request-body-container' data-selected-request-body-type="${this.selectedRequestBodyType}">
        ...
        ${this.request_body.description?U`<div class="m-markdown" style="margin-bottom:12px">${k_(We(this.request_body.description))}</div>`:""}
    ...
    `}formDataParamAsObjectTemplate(e,t,r){var n;const o=lP(t,{}),a=cP(t,"json",t.examples,t.example,"true"===this.callback||"true"===this.webhook,"true"!==this.callback&&"true"!==this.webhook,"text",!1);return U`
    ...
    `}formDataTemplate(e,t,r=""){const n=[];if(e.properties){for(const r in e.properties){var o,a;const i=e.properties[r];if(i.readOnly)continue;const s=i.examples||i.example||"",l=i.type,c=Z_(i),p="read focused".includes(this.renderStyle)?"200px":"160px",d=X_(c.examples||c.example,c.type);n.push(U`
        ...
        ${"object"===l?"":U`
            <tr>
              ...
              <td colspan="2" style="border:none; margin-top:0; padding:0 5px 8px 5px;"> 
                <span class="m-markdown-small">${k_(We(i.description||""))}</span>
      ...
      <textarea
        ...
        style="width:100%"
      ></textarea>
      ${e.description?U`<span class="m-markdown-small">${k_(We(e.description))}</span>`:""}
    `}curlSyntaxTemplate(e="flex"){return U`
      ...
      <div class="tab-panel col" style="border-width:0 0 1px 0;">
        ...
        <div class="tab-content col m-markdown" style="flex:1; display:${"headers"===this.activeResponseTab?"flex":"none"};" >
          ...
          <pre style="white-space:pre"><code>${k_(Ge().highlight(this.responseHeaders,Ge().languages.css,"css"))}</code></pre>
        </div>
    ...
    `}generateTree(e,t="object",r="",n="",o="",a=0,i=0,s=""){var l,c;if("true"===this.schemaHideReadOnly){if("array"===t&&"readonly"===s)return;if(e&&"readonly"===e["::readwrite"])return}if("true"===this.schemaHideWriteOnly){if("array"===t&&"writeonly"===s)return;if(e&&"writeonly"===e["::readwrite"])return}if(!e)return U`<div class="null" style="display:inline;">
        ...
        ${p>=0&&n?U`
            <div class='tr ${p<=this.schemaExpandLevel?"expanded":"collapsed"} ${e["::type"]}' data-obj='${h}' title="${e["::deprecated"]?"Deprecated":""}">
              ...
              <div class='td key-descr m-markdown-small' style='line-height:1.7'>${k_(We(o||""))}</div>
            </div>`:U`
    ...
    `}resetSelection(){this.selectedStatus="",this.selectedMimeType=""}responseTemplate(){if(!this.responses)return"";for(const n in this.responses){this.selectedStatus||(this.selectedStatus=n);const o={};for(const r in null===(e=this.responses[n])||void 0===e?void 0:e.content){var e,t;const a=this.responses[n].content[r];this.selectedMimeType||(this.selectedMimeType=r);const i=lP(a.schema,{}),s=cP(a.schema,r,a.examples,a.example,"true"!==this.callback&&"true"!==this.webhook,"true"===this.callback||"true"===this.webhook,r.includes("json")?"json":"text");o[r]={description:this.responses[n].description,examples:s,selectedExample:(null===(t=s[0])||void 0===t?void 0:t.exampleId)||"",schemaTree:i}}const a=[];for(const e in null===(r=this.responses[n])||void 0===r?void 0:r.headers){var r;a.push({name:e,...this.responses[n].headers[e]})}this.headersForEachRespStatus[n]=a,this.mimeResponsesForEachStatus[n]=o}return U`
      ...
      ${Object.keys(this.responses).map((e=>{var t,r;return U`
        <div style = 'display: ${e===this.selectedStatus?"block":"none"}' >
          <div class="top-gap">
            <span class="resp-descr m-markdown ">${k_(We((null===(t=this.responses[e])||void 0===t?void 0:t.description)||""))}</span>
    ...
    `}responseHeaderListTemplate(e){return U`
        ...
        ${e.map((e=>{var t,r;return U`
          <tr>
            ...
            <td style="padding:8px; vertical-align: baseline; border-top: 1px solid var(--light-border-color);text-overflow: ellipsis;">
              <div class="m-markdown-small regular-font" >${k_(We(e.description||""))}</div>
            </td>
            <td style="padding:8px; vertical-align: baseline; border-top: 1px solid var(--light-border-color); text-overflow: ellipsis;">
      ...
      ${1===e.examples.length?U`
          ${"json"===e.examples[0].exampleFormat?U`
              ...
              ${e.examples[0].exampleDescription?U`<div class="m-markdown-small" style="padding: 4px 0"> ${k_(We(e.examples[0].exampleDescription||""))} </div>`:""}
              <json-tree 
                render-style = '${this.renderStyle}'
...
`;function zP(){var e;return document.addEventListener("close",(()=>{this.showAdvancedSearchDialog=!1})),document.addEventListener("open",this.onOpenSearchDialog),U`
    <dialog-box 
      heading="Search" 
  ...
  *, *:before, *:after { box-sizing: border-box; }
        ...
        <div class='main-content-inner--${this.renderStyle}-mode'>
          ${!0===this.loading?U`<div class='loader'></div>`:U`
              ${!0===this.loadFailed?U`<div style='text-align: center;margin: 16px;'> Unable to load the Spec</div>`:U`
                  ...
                  ${"focused"===this.renderStyle?U`${PP.call(this)}`:U`
  ...
  `}function JP(){return U`
    ...
    ${this.resolvedSpec.schemaAndExamples.map((e=>{var t;const r=cP(e.schema,"json",e.examples,e.example,!0,!1,"json",!0);return e.selectedExample=null===(t=r[0])||void 0===t?void 0:t.exampleId,U`
        <section id='${e.elementId}' class='json-schema-and-example regular-font' style="display:flex; flex-direction: column; border:1px solid var(--border-color); margin-bottom:32px; border-top: 5px solid var(--border-color)">
          <div style="padding:16px; border-bottom: 1px solid var(--border-color)">
            ...
            <span class="json-schema-description m-markdown ">${k_(We(e.description||""))}</span>
          </div>  
