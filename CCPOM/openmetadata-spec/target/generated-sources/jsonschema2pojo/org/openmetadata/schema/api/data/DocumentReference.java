...
public class DocumentReference {
    ...
    /**
     * Name that identifies the source of an external knowledge center document. Example `HealthCare.gov`.
     * 
     */
    @JsonProperty("name")
    @JsonPropertyDescription("Name that identifies the source of an external knowledge center document. Example `HealthCare.gov`.")
    private String name;
    /**
     * Name that identifies the source of an external knowledge center document. Example `HealthCare.gov`.
     * 
    ...
    public DocumentReference withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public DocumentReference withEndpoint(URI endpoint) {
        this.endpoint = endpoint;
        return this;
    }
