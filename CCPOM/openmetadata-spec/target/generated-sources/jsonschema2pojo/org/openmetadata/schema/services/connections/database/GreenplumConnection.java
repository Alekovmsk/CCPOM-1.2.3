...
public class GreenplumConnection {
    ...
    @JsonPropertyDescription("SSL Mode to connect to Greenplum database.")
    private GreenplumConnection.SslMode sslMode = GreenplumConnection.SslMode.fromValue("disable");
    /**
     * SSL Config
     * <p>
     ...
     */
    @JsonProperty("sslMode")
    public GreenplumConnection.SslMode getSslMode() {
        return sslMode;
    }
     ...
     */
    @JsonProperty("sslMode")
    public void setSslMode(GreenplumConnection.SslMode sslMode) {
        this.sslMode = sslMode;
    }

    public GreenplumConnection withSslMode(GreenplumConnection.SslMode sslMode) {
        this.sslMode = sslMode;
        return this;
    }
    ...
    public enum SslMode {
        ...
        private final String value;
        private final static Map<String, GreenplumConnection.SslMode> CONSTANTS = new HashMap<String, GreenplumConnection.SslMode>();

        static {
            for (GreenplumConnection.SslMode c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }
        ...
        @JsonCreator
        public static GreenplumConnection.SslMode fromValue(String value) {
            GreenplumConnection.SslMode constant = CONSTANTS.get(value);
            if (constant == null) {
                throw new IllegalArgumentException(value);
            } else {
                return constant;
