...
public class App implements EntityInterface
{
    ...
    /**
     * Full Qualified ClassName for the Schedule
     * (Required)
     * 
     */
    @JsonProperty("className")
    @JsonPropertyDescription("Full Qualified ClassName for the Schedule")
    @NotNull
