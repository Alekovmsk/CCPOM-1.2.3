...
public final class EntityUtil {
  ...
  public static final Comparator<KnowledgeCenterDocument> compareKnowledgeCenterDocument =
      Comparator.comparing(KnowledgeCenterDocument::getName);
  public static final Comparator<ClientCenterClient> compareClientCenterClient =
      Comparator.comparing(ClientCenterClient::getName);
  ...
  public static final BiPredicate<KnowledgeCenterDocument, KnowledgeCenterDocument> knowledgeCenterDocumentMatch =
      (filter1, filter2) -> filter1.getFullyQualifiedName().equals(filter2.getFullyQualifiedName());

  public static final BiPredicate<ClientCenterClient, ClientCenterClient> clientCenterClientMatch =
      (filter1, filter2) -> filter1.getFullyQualifiedName().equals(filter2.getFullyQualifiedName());
  ...
  public static final BiPredicate<DocumentReference, DocumentReference> documentReferenceMatch =
      (ref1, ref2) -> ref1.getName().equals(ref2.getName()) && ref1.getEndpoint().equals(ref2.getEndpoint());
  public static final BiPredicate<ClientReference, ClientReference> clientReferenceMatch =
      (ref1, ref2) -> ref1.getName().equals(ref2.getName()) && ref1.getEndpoint().equals(ref2.getEndpoint());

  public static final BiPredicate<Indicator, Indicator> indicatorMatch =
      (ref1, ref2) ->
          ref1.getNumber().equals(ref2.getNumber())
              && ref1.getIndex().equals(ref2.getIndex())
              && ref1.getDescription().equals(ref2.getDescription())
              && ref1.getTargetValue().equals(ref2.getTargetValue())
              && ref1.getWeight().equals(ref2.getWeight());
  public static final BiPredicate<SpdIndicator, SpdIndicator> spdIndicatorMatch =
      (ref1, ref2) ->
          ref1.getNumber().equals(ref2.getNumber())
              && ref1.getIndex().equals(ref2.getIndex())
              && ref1.getDescription().equals(ref2.getDescription())
              && ref1.getTargetValue().equals(ref2.getTargetValue())
              && ref1.getWeight().equals(ref2.getWeight());
  public static final BiPredicate<SpdRequirement, SpdRequirement> spdRequirementMatch =
      (ref1, ref2) ->
          ref1.getReqNumber().equals(ref2.getReqNumber()) && ref1.getReqDescription().equals(ref2.getReqDescription());
  public static final BiPredicate<DataSourceEl, DataSourceEl> domainDataSourcesListMatch =
      (ref1, ref2) ->
          ref1.getElNumber().equals(ref2.getElNumber())
              && ref1.getName().equals(ref2.getName())
              && ref1.getType().equals(ref2.getType())
              && ref1.getLoadMode().equals(ref2.getLoadMode())
              && ref1.getLoadObjectsList().equals(ref2.getLoadObjectsList());
  public static final BiPredicate<DomainTeamMember, DomainTeamMember> domainTeamMatch =
      (ref1, ref2) ->
          ref1.getElNumber().equals(ref2.getElNumber())
              && ref1.getFullName().equals(ref2.getFullName())
              && ref1.getSsp().equals(ref2.getSsp())
              && ref1.getRole().equals(ref2.getRole())
              && ref1.getResponseArea().equals(ref2.getResponseArea());
  public static final BiPredicate<DomainQuota, DomainQuota> domainQuotasListMatch =
      (ref1, ref2) ->
          ref1.getElNumber().equals(ref2.getElNumber())
              && ref1.getSubsystem().equals(ref2.getSubsystem())
              && ref1.getResourceType().equals(ref2.getResourceType())
              && ref1.getQuotaSize().equals(ref2.getQuotaSize())
              && ref1.getComment().equals(ref2.getComment());
  public static final BiPredicate<EntityEl, EntityEl> entityListMatch =
      (ref1, ref2) ->
          ref1.getName().equals(ref2.getName())
              && ref1.getSchema().equals(ref2.getSchema())
              && ref1.getDb().equals(ref2.getDb());

  public static boolean compare(String str1, String str2) {
    return (str1 == null ? str2 == null : str1.equals(str2));
  }

  public static final BiPredicate<SpdMember, SpdMember> spdMemberMatch =
      (ref1, ref2) ->
          ref1.getMemberType().equals(ref2.getMemberType())
              && ref1.getMemberNumber().equals(ref2.getMemberNumber())
              && ref1.getMemberName().equals(ref2.getMemberName())
              && ref1.getMemberShortName().equals(ref2.getMemberShortName())
              && ref1.getMemberShortDescription().equals(ref2.getMemberShortDescription())
              && ref1.getMemberOwner().equals(ref2.getMemberOwner())
              && ref1.getMemberManager().equals(ref2.getMemberManager())
              && ref1.getMemberDomainAttribute().equals(ref2.getMemberDomainAttribute())
              // && ref1.getMemberDomainName().equals(ref2.getMemberDomainName())
              && compare(ref1.getMemberDomainName(), ref2.getMemberDomainName())
              // && ref1.getMemberDomainShortName().equals(ref2.getMemberDomainShortName())
              && compare(ref1.getMemberDomainShortName(), ref2.getMemberDomainShortName())
              // && ref1.getMemberDomainShortDescription().equals(ref2.getMemberDomainShortDescription())
              && compare(ref1.getMemberDomainShortDescription(), ref2.getMemberDomainShortDescription())
              // && ref1.getMemberDomainOwner().equals(ref2.getMemberDomainOwner())
              && compare(ref1.getMemberDomainOwner(), ref2.getMemberDomainOwner())
              // && ref1.getMemberDomainTechLeader().equals(ref2.getMemberDomainTechLeader())
              && compare(ref1.getMemberDomainTechLeader(), ref2.getMemberDomainTechLeader());
  ...
  public static TagLabel toTagLabel(Dla dla) {
    return new TagLabel()
        .withName(dla.getName())
        .withDisplayName(dla.getDisplayName())
        .withDescription(dla.getDescription())
        .withStyle(dla.getStyle())
        .withTagFQN(dla.getFullyQualifiedName())
        .withDescription(dla.getDescription())
        .withSource(TagSource.DLACLASSIFICATION);
  }

  public static TagLabel toTagLabel(Spd spd) {
    return new TagLabel()
        .withName(spd.getName())
        .withDisplayName(spd.getDisplayName())
        .withDescription(spd.getDescription())
        .withStyle(spd.getStyle())
        .withTagFQN(spd.getFullyQualifiedName())
        .withDescription(spd.getDescription())
        .withSource(TagSource.SPDCLASSIFICATION);
  }

  public static TagLabel toTagLabel(AutoSystem autoSystem) {
    return new TagLabel()
        .withName(autoSystem.getName())
        .withDisplayName(autoSystem.getDisplayName())
        .withDescription(autoSystem.getDescription())
        .withStyle(autoSystem.getStyle())
        .withTagFQN(autoSystem.getFullyQualifiedName())
        .withDescription(autoSystem.getDescription())
        .withSource(TagSource.AUTOSYSTEMCLASSIFICATION);
  }

  public static TagLabel toTagLabel(UserEsk userEsk) {
    return new TagLabel()
        .withName(userEsk.getName())
        .withDisplayName(userEsk.getDisplayName())
        .withDescription(userEsk.getDescription())
        .withStyle(userEsk.getStyle())
        .withTagFQN(userEsk.getFullyQualifiedName())
        .withDescription(userEsk.getDescription())
        .withSource(TagSource.USERESKCLASSIFICATION);
  }
