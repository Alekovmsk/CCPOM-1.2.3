...
public final class Entity {
  ...
  public static final String KNOWLEDGE_CENTER_DOCUMENT = "knowledgeCenterDocument";
  public static final String KNOWLEDGE_CENTER = "knowledgeCenter";
  public static final String CLIENT_CENTER_CLIENT = "clientCenterClient";
  ...
  public static final String DLACLASSIFICATION = "dlaClassification";
  public static final String SPD = "spd";
  public static final String SPDCLASSIFICATION = "spdClassification";
  public static final String AUTOSYSTEM = "autoSystem";
  public static final String AUTOSYSTEMCLASSIFICATION = "autoSystemClassification";
  public static final String USERESK = "userEsk";
  public static final String USERESKCLASSIFICATION = "userEskClassification";
