...
public class DomainResource extends EntityResource<Domain, DomainRepository> {
  ...
  static final String FIELDS = "children,owner,experts,tags";
  ...
  private Domain getDomain(CreateDomain create, String user) {
    ...
    return repository
        ...
        .withDomainOwner(create.getDomainOwner())
        .withDataSourcesList(create.getDataSourcesList())
        .withDomainQuotasList(create.getDomainQuotasList())
        .withDomainTeam(create.getDomainTeam())
