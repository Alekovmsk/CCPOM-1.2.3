 ...
 */
@JsonPropertyOrder({
  CreateTableProfile.JSON_PROPERTY_COLUMN_PROFILE,
  CreateTableProfile.JSON_PROPERTY_SYSTEM_PROFILE,
  CreateTableProfile.JSON_PROPERTY_TABLE_PROFILE
})
...
public class CreateTableProfile {
  ...
  private List<SystemProfile> systemProfile = null;
  ...
  public CreateTableProfile columnProfile(List<ColumnProfile> columnProfile) {
    
    this.columnProfile = columnProfile;
    return this;
  }

  public CreateTableProfile addColumnProfileItem(ColumnProfile columnProfileItem) {
    if (this.columnProfile == null) {
      this.columnProfile = new ArrayList<>();
    }
    this.columnProfile.add(columnProfileItem);
    return this;
  }
  ...
  **/
  ...
  public CreateTableProfile systemProfile(List<SystemProfile> systemProfile) {
    
    this.systemProfile = systemProfile;
    return this;
  }

  public CreateTableProfile addSystemProfileItem(SystemProfile systemProfileItem) {
    if (this.systemProfile == null) {
      this.systemProfile = new ArrayList<>();
    }
    this.systemProfile.add(systemProfileItem);
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CreateTableProfile createTableProfile = (CreateTableProfile) o;
    return Objects.equals(this.columnProfile, createTableProfile.columnProfile) &&
        Objects.equals(this.systemProfile, createTableProfile.systemProfile) &&
        Objects.equals(this.tableProfile, createTableProfile.tableProfile);
  }

  @Override
  public int hashCode() {
    return Objects.hash(columnProfile, systemProfile, tableProfile);
  }
