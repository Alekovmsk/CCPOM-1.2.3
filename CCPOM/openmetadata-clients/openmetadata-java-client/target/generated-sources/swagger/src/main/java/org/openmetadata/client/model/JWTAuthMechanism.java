 ...
 */
@JsonPropertyOrder({
  JWTAuthMechanism.JSON_PROPERTY_JW_T_TOKEN,
  JWTAuthMechanism.JSON_PROPERTY_JW_T_TOKEN_EXPIRES_AT,
  JWTAuthMechanism.JSON_PROPERTY_JW_T_TOKEN_EXPIRY
})
...
public class JWTAuthMechanism {
  ...
  public enum JwTTokenExpiryEnum {
    ...
    JwTTokenExpiryEnum(String value) {
      this.value = value;
    }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "")
  @JsonProperty(JSON_PROPERTY_JW_T_TOKEN_EXPIRY)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.jwTToken, jwTAuthMechanism.jwTToken) &&
        Objects.equals(this.jwTTokenExpiresAt, jwTAuthMechanism.jwTTokenExpiresAt) &&
        Objects.equals(this.jwTTokenExpiry, jwTAuthMechanism.jwTTokenExpiry);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jwTToken, jwTTokenExpiresAt, jwTTokenExpiry);
  }
  ...
  public String toString() {
    ...
    sb.append("    jwTTokenExpiresAt: ").append(toIndentedString(jwTTokenExpiresAt)).append("\n");
    sb.append("    jwTTokenExpiry: ").append(toIndentedString(jwTTokenExpiry)).append("\n");
    sb.append("}");
    return sb.toString();
  }
