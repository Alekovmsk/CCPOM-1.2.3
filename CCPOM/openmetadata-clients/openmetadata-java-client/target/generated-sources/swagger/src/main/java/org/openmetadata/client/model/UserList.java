...
@JsonPropertyOrder({
  ...
  UserList.JSON_PROPERTY_ERRORS,
  UserList.JSON_PROPERTY_PAGING
})
...
public class UserList {
  ...
  **/
  ...
  public UserList errors(List<String> errors) {
    
    this.errors = errors;
    return this;
  }

  public UserList addErrorsItem(String errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public UserList paging(Paging paging) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, userList.data) &&
        Objects.equals(this.errors, userList.errors) &&
